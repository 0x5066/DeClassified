...
System.onScriptLoaded(){
	...
	bitrateText = player.findObject("kbps");
	frequencyText = player.findObject("khz");
...
System.onStop(){
	songInfoTimer.stop();
	bitrateText.setText("kbps: ");
	frequencyText.setText("khz: ");
}
...
getSonginfo(String SongInfoString) {
	...
	if(tkn != "") {bitrateText.setText("kbps: "+tkn);}
	if(bitrateint < 100) {bitrateText.setText("kbps: "+tkn);}
	if(bitrateint < 10) {bitrateText.setText("kbps: "+tkn);}
	if(bitrateint > 1000) {bitrateText.setText("kbps: "+strleft(tkn, 2)+"H");} //what's this? Hhousands?
	if(bitrateint > 10000) {bitrateText.setText("kbps: "+strleft(tkn, 1)+"C");} //Cillions???
	if(bitrateint == 0 || bitrateint == -1) {bitrateText.setText("kbps: 0");}
	...
	if(tkn != "") {frequencyText.setText("khz: "+tkn);}
	if(freqint < 100) {frequencyText.setText("khz: "+tkn);}
	if(freqint < 10) {frequencyText.setText("khz: "+tkn);}
	if(freqint == 0 || freqint == -1 ) {frequencyText.setText("khz: 0");}
